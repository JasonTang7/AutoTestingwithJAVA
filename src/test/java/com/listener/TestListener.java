...
public class TestListener extends TestListenerAdapter
{
	...
	Logger log =LogManager.getLogger("TestListener");
...
//			Reporter.log("<a color='Blue' face='verdana' size='2'><b>"+Assert.doAssert()+"</b></a>");
	...
	{	
		...
		String sVideoPath = ReportSetup.getVideosPath() + fileSeperator + "Videos" + fileSeperator + tname + "(1).avi";
		if(new File(ReportSetup.getVideosPath()+fileSeperator+tname+"(1).avi").exists())
		{
			log.info("sVideoPath--" + sVideoPath,  tname);
			return sVideoPath;
		}
		else
		{
			String sVideoPath2 = sVideoPath.substring(0,sVideoPath.length()-7)+".avi";
			log.info("sVideoPath2--" + sVideoPath2 + "---sVideoPath---" + sVideoPath);
			return sVideoPath2;
		}
	}
}
